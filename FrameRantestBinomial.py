...
class FrameRantestBinomial(object):
    ...
    def createFrame(self):
        ...
        frame = Tk()
        frame.title('DC_PyPs : Randomisation test - binomial data')
        frame.geometry('480x700')

        message = Message(frame, width=420, text=Rantest.introd)
        message.grid(row=0, column=0, rowspan=15, columnspan=4)

        frame_s1 = LabelFrame(frame, text="Sample 1")
        frame_s1.grid(row=16, rowspan=3,  columnspan=4, padx=20, sticky=W)
        Label(frame_s1, text="Successes:").grid(row=0, column=0, padx=10, pady=10)
        Label(frame_s1, text="Failures:").grid(row=0, column=2, pady=10)

        frame_s2 = LabelFrame(frame, text="Sample 2")
        frame_s2.grid(row=20, rowspan=3,  columnspan=4, padx=20, sticky=W)
        Label(frame_s2, text="Successes:").grid(row=0, column=0, padx=10, pady=10, sticky=E)
        Label(frame_s2, text="Failures:").grid(row=0, column=2, pady=10)
        ...
        Label(frame, text="Number of randomisations:").grid(row=24, column=1, columnspan=2, pady=5, sticky=E)
        ...
        b1 = Button(frame, text="Calculate", command=self.calback1).grid(row=26, columnspan=4, pady=5)
        ...
        b3 = Button(frame, text="Plot Distribution", command=self.calback2).grid(row=40, columnspan=4, pady=10)

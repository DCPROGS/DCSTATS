...
from TkGUI.FrameFieller import FrameFieller
from TkGUI.FrameRantestContinuous import FrameRantestContinuous
from TkGUI.FrameRantestBinomial import FrameRantestBinomial

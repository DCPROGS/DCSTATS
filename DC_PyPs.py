...
if __name__ == "__main__":
    ...
    # by contrast Tcl 8.4 is 32-bit and non-retina - used by 2.7.1 which is the default on AJRP's retina macbook
    # see
    ...
    b2 = Button(lframe, text=" Randomisation test: Continuous data ", command=on_rantest_continuous, highlightbackground="#dcdcdc")
    b3 = Button(lframe, text="  Randomisation test: Binomial data  ", command=on_rantest_binomial, highlightbackground="#dcdcdc")
    b4 = Button(lframe, text=" Fieller's theorem for SD of a ratio ", command=on_fieller, highlightbackground="#dcdcdc")
    b2.pack()
    b3.pack()
    b4.pack()
